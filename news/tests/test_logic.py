...
class TestCommentCreation(TestCase):
    ...
    def test_anonymous_user_cant_create_comment(self):
        """Тест на невозможность комментирования анонимным пользователем."""
        self.client.post(self.url, data=self.form_data)
        comments_count = Comment.objects.count()
        self.assertEqual(comments_count, 0)

    def test_user_can_create_comment(self):
        """Тест на возможность комментирования авторизованным пользователем."""
...
class TestCommentEditDelete(TestCase):
    ...
    def test_user_cant_delete_comment_of_another_user(self):
        """Тест на невозможность удаления чужого комментария."""
    ...
    def test_user_cant_edit_comment_of_another_user(self):
        """Тест на невозможность редактирования чужого комментария."""
